...
redSuite(
    ...
    redGroup(
        "RedBufferInfo Test",
        // redTest("RedBufferInfo - VERTEX_SHADER 생성 테스트", function (unit) {
        //     var t0;
        //     t0 = RedBufferInfo(
        //         testGL, 'basic',
        ...
        //     )
        //     unit.run(t0 == RedBufferInfo(testGL, 'basic'))
        // }, true),
        // redGroup(
        //     '벨리데이션 확인',
        ...
        //         unit.run(t0)
        //     }, false),
        //     redTest("RedBufferInfo - 문자열만 허용 : key", function (unit) {
        //         var t0;
        //         t0 = true
        //         try {
        //             RedBufferInfo(
        ...
        //         unit.run(t0)
        //     }, false),
        //     redTest("RedBufferInfo - RedShaderInfo만 허용 : vShaderInfo", function (unit) {
        //         var t0;
        //         t0 = true
        //         try {
        //             RedBufferInfo(
        ...
        //         unit.run(t0)
        //     }, false),
        //     redTest("RedBufferInfo - RedShaderInfo만 허용 : fShaderInfo", function (unit) {
        //         var t0;
        //         t0 = true
        //         try {
        //             RedBufferInfo(

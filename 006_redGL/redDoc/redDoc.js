        ...
        (function () {
            ...
            parseDoc = function (url) {
                ...
                tLoader.onAllLoaded(function (rsList) {
                    ...
                    var groupBox, propertybox, methodBox, eventBox, descripttionBox, listBox,constBox
                    var makeBox;
                    var makeDocObject;
                    ...
                    exampleParser = function (v, parentBox) {
                        var tTitle, t1, t2;
                        parentBox.S(
            ...
            Recard.Dom('div').S(
                ...
                '<a href="https://github.com/redcamel/Recard" style="color:#222;text-decoration:none">https://github.com/redcamel/Recard</a>'+
                '</div>',
                '<','body'
            )

...
testLight.position[1] = 10
testLight.position[2] = 0
testLight.direction[0] = -0.5
testLight.direction[1] = -1
testLight.direction[2] = 0
testLight.uSpotCosCuttoff = 0.6
console.log(testLight.color)
testScene.addLight(testLight)
...
var renderer = RedRender(testGL, testScene, function (time) {
	...
	testCamera.setPosition(Math.sin(time / 3000) * 180, 180, Math.cos(time / 3000) * 180)
